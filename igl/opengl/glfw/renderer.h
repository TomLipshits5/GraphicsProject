...
#include <tutorial/Project/ShapeWrapper.h>
...
// Callbacks
    ...
    void reformatCameras(int cameraIndx, float relationWH);
    ...
    inline void SetCameraD(int infoIndx, unsigned int cameraIndx) { drawInfos[infoIndx]->SetCamera(cameraIndx); }

    inline int GetCameraD(int infoIndx) { return drawInfos[infoIndx]->cameraIndx; }
    ...
    void resetCameraParams(int cameraIndx);
    ...
    Eigen::Vector3f cameraPosition = Eigen::Vector3f(0, 0, 0);
